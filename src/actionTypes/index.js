...
export const TOGGLE_FILTER_VISIBLE = 'TOGGLE_FILTER_VISIBLE';
...
export const SET_TRAIN_DEPART = 'SET_TRAIN_DEPART';
export const SET_TRAIN_ARRIVE = 'SET_TRAIN_ARRIVE';
export const SET_DEPART_TIME_STRING = 'SET_DEPART_TIME_STRING';
export const SET_ARRIVE_TIME_STRING = 'SET_ARRIVE_TIME_STRING';
